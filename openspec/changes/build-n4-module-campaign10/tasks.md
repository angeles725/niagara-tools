...
- [ ] **[lead]** WP-stale-neg exit 0 + row printed · WP-stale-strict exit 1 · uncovered FAIL exit 1 byte-identical · exit 3 preserved · real-tree 5 STALE rows root-invariant · action rows :64/:65 not STALE · OBSERVED mutation flip (OPERATOR-only) · `shellcheck` 0 · 0 trailers · ledger settle.
