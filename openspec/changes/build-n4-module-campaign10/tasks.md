...
- [ ] 4.7 OBSERVED mutation (ONE): revert the subshell `cd "$rt"` at `:62` → S24-cwd FAIL (WiringTests cannot find src from a non-profile cwd), restore → GREEN. Record verbatim RED-then-GREEN. `[ev: SC-7; D4c; 896846176 §PR4]`
