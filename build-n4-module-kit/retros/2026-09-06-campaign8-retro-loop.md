...
on the branch (RL1–RL6 at commit 452a840; RL7 added in this session); GREEN was reached in this session.
...
- bats: 289 tests, 0 failures (284 pre-existing + 7 new RL tests). shellcheck clean both scripts.
