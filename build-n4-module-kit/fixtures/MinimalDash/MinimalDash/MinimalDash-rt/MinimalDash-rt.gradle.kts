 ...
 * MinimalDash-rt — minimal correct N4 dashboard facade skeleton (rt profile).
 */
...
description = "MinimalDash rt — minimal correct N4 dashboard facade skeleton"
...
tasks.named<Bajadoc>("bajadoc") {
  includePackage("com.angeles.MinimalDash")
}
