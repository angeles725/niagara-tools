...
5b. Peer QA session: before every code PR, run a peer QA session; the RED bats test MUST be cited by its QA branch name (K13) — a stale hash is not a biting RED and does not count as peer-verified. `[ev: METHODOLOGY.md K13]`
