...
retro_pending: true                 # campaign-11 PR3 retro filed (campaign11-client-root, pending)
retro_pending: true                 # campaign-10 retros folded at C10 close (lint-timers-scope, ext-writable-per-slot, silent-protection-pattern-b, run-pure-test-cwd, write-path-stale, close-process-meta-lessons)
last_commit: TBD — chore/c10-close merge sha (fill post-merge)
last_session: 2026-09-06 · Campaign 10 CLOSE v0.21.0 — lint precision S21-S25 + client hygiene S26; 6 retros folded; #89 resolved; client versions carry over 2.2.0/2.1.0/2.2.0 (PR6 no bump).
