...
last_commit: b84b71a — RT doctrine fold PR15: §RT-control-logic logic.md, §history-ext + §slot-types-ext-writes logic-authoring.md, dashboard.md pointer (Campaign 8 PR15)
last_session: 2026-09-06 · Campaign 8 PR15: RT doctrine fold from corpus B804/B805/B808/B822/B823/B825/B826/B828. Folded: §RT-control-logic (logic.md), §history-ext B804 (logic-authoring.md), §slot-types-for-ext-writes B823 (logic-authoring.md), dashboard.md pointer. Guards: 56/56 cited, 258/258 bats, sweep-build-state exit 0, sweep-fold-audit --strict exit 0. Retro + INDEX + BUILD-STATE filed.
