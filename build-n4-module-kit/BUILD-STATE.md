...
last_commit: fix(lint-wb-threading): follow same-class callees to depth 3 (WBT1d), real BBatchLinkEditor shape flagged
last_session: 2026-09-05 · Campaign 8 PR11 rev2 (WBT1d): lint-wb-threading.sh depth-3 callee expansion; doInvoke expanded via private/protected same-class methods to depth 3 (cycle-safe); BBatchLinkEditor.java now WARNs ui-thread-traversal at :303 (chain: searchNavTree -> collectNavMatches -> getNavChildren); WBT1d + WBT1d-guard pins green; 256/256 bats; shellcheck exit 0; all guards green.
<!-- /build-state.v1 -->
