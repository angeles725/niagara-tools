...
retro_required: true                 # GATED — Campaign 7 PR1 retro owed
retro_pending: true                  # GATED — campaign7-retro-fold FILED as review-status: pending; fold-status in retros/INDEX.md
last_commit: Campaign 7 PR1          # docs/c7-retro-fold — fold 9 Campaign-6 retros
last_session: 2026-09-05 · Campaign 7 PR1: folded 9 Campaign-6 retros (K11–K14, §7 envelope-pairing rule, CONTRIBUTING §9 SDD ledger, two-reads rule, 6 folded-as-code citations). 0 pending retros remain from Campaign 6. PR1 retro filed (campaign7-retro-fold, pending). Next: PR2 docs/c7-tool-integration.
<!-- /build-state.v1 -->
