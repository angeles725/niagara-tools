...
retro_required: true                 # GATED — Campaign 6 PR8 conformance lints + retro-debt aging
retro_pending: true                  # GATED — campaign6-conformance-lints retro FILED; review-status: pending
last_commit: Campaign 6 PR8          # updated at PR8 push (feat/c6-conformance-lints)
last_session: 2026-09-05 · Campaign 6 PR8 (conformance lints): lint-timers.sh (TL1-TL4 + named mutations; BEvaporatorUnit FAIL, BDefrostController/BCompressorControl PASS); sweep-build-state.sh --age mode E5 (D1-D6 + named mutations); preflight.sh WSL jdk8 fallback PF5; T8.3 no-op (V17 already guards); T8.5 verified advisory. PR8 retro: 2026-09-05-campaign6-conformance-lints.md (exit a). Campaign 6 complete.
<!-- /build-state.v1 -->
