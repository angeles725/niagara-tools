...
last_commit: docs(build-n4-module): BUILD-LOOP §4 Gradle task matrix + version-bump checklist (campaign 8 PR14)
last_session: 2026-09-05 · Campaign 8 PR14: BUILD-LOOP.md §4.a Gradle task matrix (clean/slotomatic/compileJava/jar/build/moduleTestJar/niagaraTest/bajadoc) + §4.b version-bump checklist (vendorVersion/bajaVersion/restart mandate/schema-risk ref); exit-31 regression pin BS-lock/BS-lock-hint already green from 15e4808; 12/12 build-sh.bats; sweep-fold-audit --strict exit 0 (56/56 cited).
<!-- /build-state.v1 -->
