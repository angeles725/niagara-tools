...
retro_pending: true                  # campaign8-lint-delays + campaign8-triage-console + campaign8-lint-timers-ext + campaign8-facets-lint + campaign8-slot-per-slot + campaign8-rc-scan + campaign8-doctrine-fold + campaign8-report-integration + campaign8-station-snapshot + campaign8-bog-audit + campaign8-wb-audit + campaign8-lint-servlet (all pending fold)
last_commit: WIP — Campaign 8 PR12 lint-servlet.sh: LSV1-LSV6+LSV4+usage+prune green (253/253 bats), shellcheck clean, K19 routing, 4 mutations proven, smokes: DashboardPan cache-nofinger WARN; chihuahua cache-nofinger+csrf-xrw-only WARN
last_session: 2026-09-05 · Campaign 8 PR12: lint-servlet.sh (new toolbelt script). auth/input-400 FAIL; unbounded-set/cache-nofinger/log-in-handler/csrf-xrw-only WARN. CsrfXrwOnly fixture + LSV4 pin added. K19 routing BUILD-LOOP.md + skill/SKILL.md. Guards: 6/6 kit-links, sweep-build-state exit 0, sweep-fold-audit --strict exit 0, 253/253 bats. Deviations: lint-servlet.sh not rc-scan --servlet (K13 RED wins); R12.2 step-up deferred C9 S12 (B803); csrf-xrw-only WARN not FAIL (B813 K3); input-400 not flagged on BDashboardServlet (all parseDouble inside try). Retro + INDEX + BUILD-STATE filed.
<!-- /build-state.v1 -->
