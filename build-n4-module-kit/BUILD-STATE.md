...
last_commit: WIP — Campaign 8 PR12 lint-servlet.sh LSV2b (catch-no-400 WARN): 11/11 LSV pins green (255/255 bats), shellcheck clean; smokes: DashboardPan 2x catch-no-400 + cache-nofinger; chihuahua catch-no-400 + cache-nofinger + csrf-xrw-only
last_session: 2026-09-05 · Campaign 8 PR12 lead-review follow-up: catch-no-400 WARN (LSV2b) added. File-level scan within servlet classes; catch around parse calls without 400 in catch body. Fixtures CatchNo400.java + CatchWith400.java. Bug fixed: append-before-brace-scan in body extraction. Retro D4 closed. Guards: shellcheck 0, sweep-build-state 0, sweep-fold-audit --strict 0, 255/255 bats.
<!-- /build-state.v1 -->
