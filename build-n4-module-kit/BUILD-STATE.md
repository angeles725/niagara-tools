...
retro_required: true                 # GATED — Campaign 6 PR1 changed toolbelt/sweep-build-state.sh
retro_pending: false                 # GATED — campaign6-marker-index-sweep retro FILED; fold-status in retros/INDEX.md as review-status: pending
last_commit: Campaign 6 PR1          # updated at PR1 merge (feat/c6-marker-index)
last_session: 2026-09-05 · Campaign 6 PR1 (v0.15.1 → v0.16.0 in progress): added marker_of() to sweep-build-state.sh — option 2-lite marker↔INDEX contract; re-stamped 2 retros from fresh→folded; 25/25 M1-M6 green; full suite 110/110; shellcheck 0.10.0 clean; sweep exit 0 on real tree. Retro: 2026-09-05-campaign6-marker-index-sweep.md (exit a).
<!-- /build-state.v1 -->
