...
retro_required: true                 # GATED — Campaign 6 PR6 adds tracked launcher + openspec archive
retro_pending: false                 # GATED — campaign6-close retro FILED; fold-status in retros/INDEX.md as review-status: pending
last_commit: Campaign 6 PR6          # updated at PR6 push (feat/c6-close)
last_session: 2026-09-05 · Campaign 6 PR6 (close): tracked skill/SKILL.md + install-skill.sh (IS1–IS4, named mutation); openspec/ tracked + slotomatic archived; ci.yml setup-java v5; slot-coverage (type-set) label; BUILD-STATE ledger B788 correction; VERSION 0.16.0 + CHANGELOG; PR6 retro. Retro: 2026-09-05-campaign6-close.md (exit a).
<!-- /build-state.v1 -->
