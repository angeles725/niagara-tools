...
retro_required: true                 # GATED — Campaign 6 PR7 adds research fold + strict fold-audit gate
retro_pending: true                  # GATED — campaign6-research-fold retro FILED; review-status: pending
last_commit: Campaign 6 PR7          # updated at PR7 push (feat/c6-research-fold)
last_session: 2026-09-05 · Campaign 6 PR7 (research fold): 27 deltas folded (Author-side SPIs, point ext, child-tree, grouping, query, templates, jobs, watchdogs, action protection, minimal module, web-tier pointers, lintable-vs-advisory); T7.5 strict fold-audit (38/38 cited); ci.yml --strict; PR7 retro. Retro: 2026-09-05-campaign6-research-fold.md (exit a).
<!-- /build-state.v1 -->
