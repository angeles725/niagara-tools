...
retro_pending: false                 # campaign-10 retros folded at C10 close (lint-timers-scope, ext-writable-per-slot, silent-protection-pattern-b, run-pure-test-cwd, write-path-stale, close-process-meta-lessons)
